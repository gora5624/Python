...
def createPDFAct(listBox):
    ...
    pdf.multi_cell(
        2080, 70, txt='Представитель отправителя _______________,  Дата_______________', align='L',)
    pdf.multi_cell(2080, 70)
    pdf.multi_cell(
        2080, 70, txt='Представитель перевозчика ________________,  Дата_______________', align='L')
