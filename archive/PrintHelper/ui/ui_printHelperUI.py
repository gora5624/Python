...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.bigButt.setGeometry(QtCore.QRect(20, 80, 361, 41))
        ...
        self.smallButt.setGeometry(QtCore.QRect(20, 200, 171, 41))
        self.smallButt.setObjectName("smallButt")
        self.smallButtPlastins = QtWidgets.QPushButton(Form)
        self.smallButtPlastins.setGeometry(QtCore.QRect(210, 200, 171, 41))
        ...
        self.smallButtBooks.setGeometry(QtCore.QRect(20, 260, 171, 41))
        self.smallButtBooks.setObjectName("smallButtBooks")
        self.smallButtCartholders = QtWidgets.QPushButton(Form)
        self.smallButtCartholders.setEnabled(True)
        self.smallButtCartholders.setGeometry(QtCore.QRect(210, 260, 171, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.smallButt.setText(_translate("Form", "Силикон маленький"))
        self.smallButtPlastins.setText(_translate("Form", "Планки маленкий"))
        self.smallButtBooks.setText(_translate("Form", "Книжки маленький"))
        self.smallButtCartholders.setText(_translate("Form", "Картхолдеры маленький"))
