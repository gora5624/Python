# Form implementation generated from reading ui file 'e:\MyProduct\Python\WB\PrintHelper\ui\printHelperUIV3.ui'
#
...
class Ui_PrintHelper(object):
    def setupUi(self, PrintHelper):
        ...
        PrintHelper.setMinimumSize(QtCore.QSize(423, 388))
        PrintHelper.setMaximumSize(QtCore.QSize(423, 730))
        font = QtGui.QFont()
        ...
        self.frameMed.setGeometry(QtCore.QRect(20, 100, 381, 241))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 402, 241))
        ...
        self.medButtHld = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        self.medButtHld.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.medButtHld.sizePolicy().hasHeightForWidth())
        self.medButtHld.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setKerning(False)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        self.medButtHld.setFont(font)
        self.medButtHld.setObjectName("medButtHld")
        self.verticalLayout_2.addWidget(self.medButtHld)
        self.medButtPlastin = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        self.medButtPlastin.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.medButtPlastin.sizePolicy().hasHeightForWidth())
        self.medButtPlastin.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setKerning(False)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        self.medButtPlastin.setFont(font)
        self.medButtPlastin.setObjectName("medButtPlastin")
        self.verticalLayout_2.addWidget(self.medButtPlastin)
        ...
        self.mainPageButt.setGeometry(QtCore.QRect(220, 350, 181, 23))
        self.mainPageButt.setObjectName("mainPageButt")
        self.frameSettings = QtWidgets.QFrame(parent=PrintHelper)
        self.frameSettings.setGeometry(QtCore.QRect(20, 10, 381, 371))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(9, 0, 361, 371))
        ...
        self.lineEditNameSize1C = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_4)
        self.lineEditNameSize1C.setObjectName("lineEditNameSize1C")
        ...
        self.lineEditNameFileSize = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_4)
        self.lineEditNameFileSize.setObjectName("lineEditNameFileSize")
        self.horizontalLayout_5.addWidget(self.lineEditNameFileSize)
        self.pushButtonChooseFileSize = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.pushButtonChooseFileSize.setMinimumSize(QtCore.QSize(10, 0))
        self.pushButtonChooseFileSize.setMaximumSize(QtCore.QSize(68, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setKerning(False)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        self.pushButtonChooseFileSize.setFont(font)
        self.pushButtonChooseFileSize.setObjectName("pushButtonChooseFileSize")
        self.horizontalLayout_5.addWidget(self.pushButtonChooseFileSize)
        self.verticalLayout_8.addLayout(self.horizontalLayout_5)
        self.addSizeButt = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.addSizeButt.setObjectName("addSizeButt")
        ...
        self.medPlAcsButt = QtWidgets.QCheckBox(parent=self.verticalLayoutWidget_4)
        self.medPlAcsButt.setObjectName("medPlAcsButt")
        self.verticalLayout_9.addWidget(self.medPlAcsButt)
        ...
        self.medHldAcsButt = QtWidgets.QCheckBox(parent=self.verticalLayoutWidget_4)
        self.medHldAcsButt.setObjectName("medHldAcsButt")
        self.verticalLayout_9.addWidget(self.medHldAcsButt)
        ...
        self.pushButtonNextListSett = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.pushButtonNextListSett.setObjectName("pushButtonNextListSett")
        self.horizontalLayout_4.addWidget(self.pushButtonNextListSett)
        self.verticalLayout_4.addLayout(self.horizontalLayout_4)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.labelSearcgSize = QtWidgets.QLabel(parent=self.verticalLayoutWidget_4)
        self.labelSearcgSize.setMaximumSize(QtCore.QSize(155, 16777215))
        self.labelSearcgSize.setObjectName("labelSearcgSize")
        self.horizontalLayout_7.addWidget(self.labelSearcgSize)
        self.comboBoxSearchSize = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_4)
        self.comboBoxSearchSize.setObjectName("comboBoxSearchSize")
        self.horizontalLayout_7.addWidget(self.comboBoxSearchSize)
        self.verticalLayout_4.addLayout(self.horizontalLayout_7)
        self.pushButtonSearchSize = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.pushButtonSearchSize.setObjectName("pushButtonSearchSize")
        self.verticalLayout_4.addWidget(self.pushButtonSearchSize)
        self.pushButtonAbortSearchSize = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_4)
        self.pushButtonAbortSearchSize.setObjectName("pushButtonAbortSearchSize")
        self.verticalLayout_4.addWidget(self.pushButtonAbortSearchSize)
        ...
        self.frameSettings2 = QtWidgets.QFrame(parent=PrintHelper)
        self.frameSettings2.setGeometry(QtCore.QRect(20, 90, 371, 291))
        self.frameSettings2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frameSettings2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frameSettings2.setObjectName("frameSettings2")
        self.lineEditMinRAM = QtWidgets.QLineEdit(parent=self.frameSettings2)
        self.lineEditMinRAM.setGeometry(QtCore.QRect(10, 30, 113, 22))
        self.lineEditMinRAM.setObjectName("lineEditMinRAM")
        self.label_8 = QtWidgets.QLabel(parent=self.frameSettings2)
        self.label_8.setGeometry(QtCore.QRect(10, 10, 261, 16))
        self.label_8.setObjectName("label_8")
        self.tableWidgetSizes = QtWidgets.QTableWidget(parent=PrintHelper)
        self.tableWidgetSizes.setGeometry(QtCore.QRect(20, 390, 381, 291))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tableWidgetSizes.sizePolicy().hasHeightForWidth())
        self.tableWidgetSizes.setSizePolicy(sizePolicy)
        self.tableWidgetSizes.setMinimumSize(QtCore.QSize(381, 286))
        self.tableWidgetSizes.setMaximumSize(QtCore.QSize(500, 471))
        self.tableWidgetSizes.setAutoScroll(True)
        self.tableWidgetSizes.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.tableWidgetSizes.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.tableWidgetSizes.setObjectName("tableWidgetSizes")
        self.tableWidgetSizes.setColumnCount(0)
        self.tableWidgetSizes.setRowCount(0)
        self.pushButtonSaveSizes = QtWidgets.QPushButton(parent=PrintHelper)
        self.pushButtonSaveSizes.setGeometry(QtCore.QRect(20, 690, 381, 24))
        self.pushButtonSaveSizes.setObjectName("pushButtonSaveSizes")
        ...
        self.tableWidgetSizes.raise_()
        self.frameBig.raise_()
        self.pushButtonSaveSizes.raise_()
    ...
    def retranslateUi(self, PrintHelper):
        ...
        self.medButtHld.setText(_translate("PrintHelper", "Картхолдеры средний станок (105*160)"))
        self.medButtPlastin.setText(_translate("PrintHelper", "Пластины средний станок (105*160)"))
        self.medButt.setText(_translate("PrintHelper", "Силикон средний станок (105*160)"))
        ...
        self.pushButtonChooseFileSize.setText(_translate("PrintHelper", "Обзор..."))
        self.addSizeButt.setText(_translate("PrintHelper", "Добавить размер"))
        ...
        self.medPlAcsButt.setText(_translate("PrintHelper", "Планки средний"))
        self.sallHldAcsButt.setText(_translate("PrintHelper", "Картхолдеры маленький"))
        self.medHldAcsButt.setText(_translate("PrintHelper", "Картхолдеры средний"))
        self.applySettButt.setText(_translate("PrintHelper", "Применить"))
        self.pushButtonNextListSett.setText(_translate("PrintHelper", "Настройки столов"))
        self.labelSearcgSize.setText(_translate("PrintHelper", "Найти размер в таблице:"))
        self.pushButtonSearchSize.setText(_translate("PrintHelper", "Найти"))
        self.pushButtonAbortSearchSize.setText(_translate("PrintHelper", "Сбросить фильтр"))
        self.settButt.setText(_translate("PrintHelper", "Настройки"))
        self.label_8.setText(_translate("PrintHelper", "Минимум памяти для предупреждения, Гб"))
        self.pushButtonSaveSizes.setText(_translate("PrintHelper", "Соханить список размеров"))
