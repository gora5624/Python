...
class Ui_PrintHelper(object):
    def setupUi(self, PrintHelper):
        ...
        self.smallButtPlastins = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        ...
        self.smallButtCartholders = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        ...
        self.frameMain = QtWidgets.QFrame(PrintHelper)
        ...
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(self.frameMain)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 5, 381, 251))
        self.verticalLayoutWidget_5.setObjectName("verticalLayoutWidget_5")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_5)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.bigButtInt = QtWidgets.QPushButton(self.verticalLayoutWidget_5)
        ...
        self.smallButtInt = QtWidgets.QPushButton(self.verticalLayoutWidget_5)
        ...
        self.medButtInt = QtWidgets.QPushButton(self.verticalLayoutWidget_5)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 120, 215))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.Highlight, brush)
        ...
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.frameSettings)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(9, 0, 361, 281))
        ...
        self.bigAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.bigAcsButt.setObjectName("bigAcsButt")
        self.verticalLayout_6.addWidget(self.bigAcsButt)
        self.medAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.medAcsButt.setObjectName("medAcsButt")
        self.verticalLayout_6.addWidget(self.medAcsButt)
        self.smallAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        ...
        self.lineEditNameSize1C = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        ...
        self.lineEditNameFileSize = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.lineEditNameFileSize.setObjectName("lineEditNameFileSize")
        self.verticalLayout_8.addWidget(self.lineEditNameFileSize)
        self.addSizeButt = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.addSizeButt.setObjectName("addSizeButt")
        self.verticalLayout_8.addWidget(self.addSizeButt)
        self.pushButtonShowSizes = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.pushButtonShowSizes.setObjectName("pushButtonShowSizes")
        ...
        self.bigSilAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.bigSilAcsButt.setObjectName("bigSilAcsButt")
        self.verticalLayout_7.addWidget(self.bigSilAcsButt)
        self.medSilAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.medSilAcsButt.setObjectName("medSilAcsButt")
        self.verticalLayout_7.addWidget(self.medSilAcsButt)
        self.smallSilAcsButt = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        ...
        self.applySettButt = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        ...
        self.settButt = QtWidgets.QPushButton(PrintHelper)
        self.settButt.setGeometry(QtCore.QRect(20, 350, 75, 23))
        self.settButt.setObjectName("settButt")
        self.lineEditPass = QtWidgets.QLineEdit(PrintHelper)
        ...
        self.frameSettings2 = QtWidgets.QFrame(PrintHelper)
        self.frameSettings2.setGeometry(QtCore.QRect(20, 90, 371, 281))
        ...
        self.lineEditMinRAM = QtWidgets.QLineEdit(self.frameSettings2)
        self.lineEditMinRAM.setGeometry(QtCore.QRect(10, 30, 113, 22))
        self.lineEditMinRAM.setObjectName("lineEditMinRAM")
        self.label_8 = QtWidgets.QLabel(self.frameSettings2)
    ...
    def retranslateUi(self, PrintHelper):
        ...
        self.addSizeButt.setText(_translate("PrintHelper", "Применить"))
        self.pushButtonShowSizes.setText(_translate("PrintHelper", "Показать все размеры"))
        ...
        self.pushButton.setText(_translate("PrintHelper", "Следующее меню"))
