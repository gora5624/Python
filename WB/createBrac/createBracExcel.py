...
while True:
    ...
    while True:
        ...
        try:
            ...
            typeProd = dfNomenclatures[dfNomenclatures.Наименование == nomenclaturesName[0]]['Тип номенклатуры производство'].values.tolist()[0]
        except:    
        ...
        dataTmp = {
            ...
            'Размер': size,
            'Код': cod,
            'Тип номенклатуры производство': typeProd,
        }
