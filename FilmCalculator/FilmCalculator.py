while True:
    ...
    if ContFlag == "да":
        while True:
            try:
                WidthFilm = int(input('Введите ширину пленки в миллиметрах: '))
            except ValueError:
                while True:
                    WidthFilm = input(
        ...
        restart = input('Запишите результат и введите "продолжить или выйти".')
        ...
        print('Неверный ввод. Нужно вводить "да" или "нет". Попробуйте ещё раз после ввода размеров.')
